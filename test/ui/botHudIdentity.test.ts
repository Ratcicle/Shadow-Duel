...
test("each bot portrait uses the approved monster, a valid square crop and a distinct accent", () => {
  ...
  assert.equal(accents.size, representatives.length);
