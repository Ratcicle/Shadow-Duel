export const shadowHeartCards = [
  ...
  {
    id: 123,
    name: "Shadow-Heart Arctroth Pursuer",
    cardKind: "monster",
    archetype: "Shadow-Heart",
    attribute: "Dark",
    level: 9,
    ...
    effects: [
      {
        ...
        targets: [
          {
            id: "arctroth_pursuer_drain_target",
            owner: "opponent",
            zone: "field",
            requireFaceup: true,
            cardKind: "monster",
        ...
        actions: [
          {
            ...
            targetRef: "arctroth_pursuer_drain_target",
            gainTargetRef: "self",
            stats: ["atk", "def"],
          },
        ],
      },
      {
        ...
        promptUser: true,
        promptMessage:
          'Activate "Shadow-Heart Arctroth Pursuer" to Special Summon 1 monster from your opponent\'s Graveyard?',
        targets: [
          {
            id: "arctroth_pursuer_opponent_gy_target",
            owner: "opponent",
            zone: "graveyard",
            cardKind: "monster",
            excludeContextCard: "destroyed",
        ...
        actions: [
          {
            type: "special_summon_from_zone",
            targetRef: "arctroth_pursuer_opponent_gy_target",
            zone: "graveyard",
            sourceOwner: "opponent",
            summonToOwner: "opponent",
            position: "choice",
          },
          {
