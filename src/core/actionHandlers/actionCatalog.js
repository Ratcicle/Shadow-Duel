...
export const ACTION_CATALOG = {
    ...
    fields: {
      ...
      atkBoostFromTarget: {
        ...
        fields: {
          ...
          stat: { enum: ["baseAtk", "baseDef", "atk", "def"] },
        },
      },
  ...
  set_facedown_defense: action({
    category: "stats",
    summary: "Changes a face-up monster to face-down Defense Position.",
    handler: "handleSetFacedownDefense",
    required: ["targetRef"],
    optional: ["lockBattlePosition"],
    fields: {
      ...COMMON_TARGET_FIELDS,
      lockBattlePosition: { type: "boolean" },
    },
    targetRef: "required",
    selection: "usesTargets",
    mutates: ["position", "faceDown", "status"],
  ...
  take_control: action({
    ...
    required: ["targetRef"],
    optional: ["player", "duration", "contextLabel"],
    fields: {
      ...COMMON_TARGET_FIELDS,
      player: { enum: ["self", "opponent"] },
      duration: { enum: ["permanent", "until_end_phase"] },
      contextLabel: { type: "string" },
    },
    targetRef: "required",
    selection: "usesTargets",
