...
import type { LuminarchActionGenerationContext } from "./contracts.js";
...
function getHandSpellActions(context: LuminarchActionGenerationContext, spellIndicesActivated: Set<number>) {
  const {
    game,
    bot,
    opponent,
...
function getSpellTrapEffectActions(context: LuminarchActionGenerationContext) {
  const {
    game,
    bot,
    opponent,
...
function getSetSpellTrapActions(context: LuminarchActionGenerationContext, spellIndicesActivated: Set<number>) {
...
export function getLuminarchSpellActions(context: LuminarchActionGenerationContext) {
  const spellIndicesActivated = new Set<number>();
  return [
