...
function isCounterattackPayoff(card: SimulatedCardState) {
...
function getConvocationCandidates(analysis: LuminarchAnalysis) {
...
export function evaluateLuminarchDefensePlan(analysis: LuminarchAnalysis = {}) {
...
export function evaluateKnightsConvocationPlan(analysis: LuminarchAnalysis = {}) {
