...
import type { LuminarchContext } from "./contracts.js";
/**
 * fusionPriority.js
 ...
 */
export function detectFusionOpportunities(context: LuminarchContext & { hand: SimulatedCardState[]; field: SimulatedCardState[]; opponent: SimulatedPlayerState }) {
  ...
  for (const fusionName in LUMINARCH_FUSIONS) {
    const fusionData = LUMINARCH_FUSIONS[fusionName as keyof typeof LUMINARCH_FUSIONS];

    // Buscar materiais no pool disponível
    const foundMaterials: SimulatedCardState[] = [];
 ...
 */
export function calculatePowerSwing(opportunity: ReturnType<typeof detectFusionOpportunities>[number], context: LuminarchContext & { hand: SimulatedCardState[]; field: SimulatedCardState[]; opponent: SimulatedPlayerState }) {
 ...
 */
export function isMaterialExpendable(material: SimulatedCardState, opportunity: ReturnType<typeof detectFusionOpportunities>[number], context: LuminarchContext & { hand: SimulatedCardState[]; field: SimulatedCardState[]; opponent: SimulatedPlayerState }) {
 ...
 */
export function shouldPrioritizeFusion(opportunity: ReturnType<typeof detectFusionOpportunities>[number], context: LuminarchContext & { hand: SimulatedCardState[]; field: SimulatedCardState[]; opponent: SimulatedPlayerState }) {
 ...
 */
export function evaluateFusionPriority(context: LuminarchContext & { hand: SimulatedCardState[]; field: SimulatedCardState[]; opponent: SimulatedPlayerState }) {
...
interface FusionOpportunity { fusionName: string; fusionData: typeof LUMINARCH_FUSIONS[keyof typeof LUMINARCH_FUSIONS]; materials: SimulatedCardState[]; poly: SimulatedCardState; stats: { atk: number; def: number } }
