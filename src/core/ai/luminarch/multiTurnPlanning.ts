 ...
 */
export function evaluateGameStance(analysis: LuminarchAnalysis) {
 ...
 */
export function estimateNextTurnResources(analysis: LuminarchAnalysis) {
 ...
 */
export function shouldCommitResourcesNow(card: SimulatedCardState, analysis: LuminarchAnalysis, stance: {stance: string}) {
 ...
 */
export function planNextTurns(analysis: LuminarchAnalysis) {
