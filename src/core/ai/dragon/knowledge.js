...
export const CARD_KNOWLEDGE = {
  ...
  "Abyssal Serpent Dragon": {
    ...
    def: 1400,
    level: 7,
    summonCondition: "normal_only",
    effect: "CANNOT be Special Summoned. Main Phase: select opp monster, send both to GY; opp standby phase both return. +800 ATK if target is fusion/ascension.",
    synergies: ["Converging Stars"],
    playPatterns: [
      "Only via Normal Summon (2 tributes) or Converging Stars (level 6 → 1 tribute)",
  ...
  "Majestic Silver Dragon": {
    ...
    playPatterns: [
      ...
      "Converging Stars makes it level 6 → 1 normal tribute (any monster)",
  ...
  "Darkness Dragon": {
    ...
    playPatterns: [
      ...
      "Converging Stars → level 4 → summon with 0 tributes",
  ...
  "Converging Stars": {
    ...
    effect: "Discard 1 card; reduce all hand monster levels by 1 until end of turn.",
    synergies: ["Abyssal Serpent Dragon", "Majestic Silver Dragon", "Darkness Dragon"],
    playPatterns: [
      "Priority: Darkness Dragon in hand → level 5→4, free summon",
      "Priority: Abyssal Serpent in hand → level 7→6, saves 1 tribute",
      "Priority: Majestic Silver in hand with 1 tribute available → level 7→6, 1 regular tribute instead of 1 Dragon tribute",
