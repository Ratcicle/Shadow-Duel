...
export interface CardKnowledge {
  ...
  playPatterns: string[];
  value: number;
  ascensionTarget?: string;
  goodTribute?: boolean;
  goodDiscard?: boolean;
}

export const CARD_KNOWLEDGE: Record<string, CardKnowledge> = {
  // ===== MONSTROS =====
 ...
 * @returns {boolean}
 */
export function isShadowHeart(card: GameCard | SimulatedCardShape | null | undefined) {
 ...
 * @returns {boolean}
 */
export function isShadowHeartByName(name: string | undefined) {
  return (name && name.startsWith("Shadow-Heart")) as boolean;
}
 ...
 */
export function getCardKnowledge(name: string | undefined) {
 ...
 * @returns {boolean}
 */
export function isBoss(name: string | undefined) {
 ...
 * @returns {boolean}
 */
export function isGoodTribute(name: string | undefined) {
  const knowledge = CARD_KNOWLEDGE[name!];
 ...
 * @returns {boolean}
 */
export function isGoodDiscard(name: string | undefined) {
  const knowledge = CARD_KNOWLEDGE[name!];
